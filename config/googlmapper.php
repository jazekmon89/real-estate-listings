...
return array(
    ...
    */
    ...
    |
    */
    'key' => env('GOOGLE_API_KEY', 'AIzaSyC8wq_Z2nrMC8eVNIw2lwRS_fpqWO16-V0'),
    //'key' => env('GOOGLE_API_KEY', 'AIzaSyAtqWsq5Ai3GYv6dSa6311tZiYKlbYT4mw'),
    //'key' => env('GOOGLE_API_KEY', 'AIzaSyCYxBPR1cMgikQvyZxk9ybYD2PmxPPRO5w'),
    ...
    */
    'markers' => array(
        ...
        |
        */
        'icon' => '/images/marker.png',//'/images/marker.png',

        'icon2'=> '/images/circle-star.png',
